...
{{< img src="security_platform/security_monitoring/guide/monitor-authentication-logs-for-security-threats/credential-stuffing-attack-signal.png" alt="Signal d'attaque par credential stuffing dans le Security Signals Explorer">}}
